\hypertarget{jeu-de-nim-lia-en-bouxeete-dallumettes}{%
...
Donner les règles du Jeu de Nim (on peut par exemple illustrer avec un
...
\begin{figure}
\centering
\includegraphics{https://raw.githubusercontent.com/ljad-cnrs/nim/main/fig2-v2.png}
\caption{fig2}
\end{figure}
...
La méthode d'apprentissage se base sur deux principes très naturels:
...
\begin{figure}
\centering
\includegraphics{https://raw.githubusercontent.com/ljad-cnrs/nim/main/fig3-v2.jpg}
\caption{fig3}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{https://raw.githubusercontent.com/ljad-cnrs/nim/main/fig1-v2.jpg}
\caption{fig1}
\end{figure}
