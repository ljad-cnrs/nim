...
Le but de la suite est de construire une machine qui apprend à jouer. Insister sur le fait qu'il ne s'agit pas de
...
On suit l'idée de la machine {\sc menace} (Matchbox Educable Noughts and Crosses Engine) 
...
\noindent Les élèves commencent l'apprentissage de la machine en suivant le protocole des figures~\ref{fig:PremApprentissage} et \ref{fig:ProtocoleApprentissage}. 
...
\begin{thebibliography}{100}%Références}
